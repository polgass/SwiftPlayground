...
class ViewController: UIViewController {
  ...
  func insertSampleData() {
      let fetchequest = NSFetchRequest(entityName: "Bowtie")
      fetchequest.predicate = NSPredicate(format: "searchKey != nil")
      let count = managedContext.countForFetchRequest(fetchequest, error: nil)
